...
public @interface CucumberOptions {
     ...
     * class. So for example if the annotated class is {@code com.example.RunCucumber}
     ...
     * <p>
     * These packages are used in addition to default described in {@code #glue}.
     */
    ...
    /**
     * Only run scenarios whose names match regular expression.
     */
    String[] name() default {};

    /**
     * Naming convention for generated snippets.
     */
    SnippetType snippets() default SnippetType.UNDERSCORE;

    /**
     * Pass the options to the JUnit module.
     */
